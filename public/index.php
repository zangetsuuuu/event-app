...
<main>
    <div class="px-4 pt-5 mt-2 text-center">
        <h1 class="display-4 fw-bold animate__animated animate__fadeIn animate__delay-1s">Welcome to Eventiqo!</h1>
        <div class="col-lg-6 mx-auto animate__animated animate__fadeIn animate__delay-1s">
